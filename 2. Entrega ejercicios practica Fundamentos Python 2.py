# %%
## Ejercicios practica Fundamentos Python 2
## Listas, tuplas y diccionarios
## Nombre: Jhon freddy alvino lozano

# %%
## A. Listas
## Crear, recorrer, filtrar y acumular
...
# Muestre el primer, tercer y último elemento de la lista.
...
## Respuesta breve: explique en una frase por qué una matriz puede modelarse como una lista de listas.
## Respuesta: Porque una matriz tiene filas y columnas, donde la lista principal agrupa las filas y cada sublista representa los elementos de una fila.
...
# Observe que modificar una tupla directamente arroja error.

punto = (10, 20)
# punto[0] = 99  # Genera TypeError

## Respuesta breve: ¿por qué esta restricción puede ser útil en un programa real?
## Respuesta: Garantiza que los datos sensibles o de configuración no sufran cambios accidentales durante la ejecución del programa.
...
# %%
## 18. Tupla como clave (Crear pares con zip)
...
# %%
## 25. Acumular desde lista de diccionarios
# Sume los montos de todas las transacciones.
...
# Complete el algoritmo que calcula el total de los créditos mayores o iguales a 100000 y registra los clientes correspondientes.
...
## Respuesta breve: indique qué estructuras aparecen en este caso y para qué se usa cada una.
## Respuesta: Hay una lista principal que organiza los registros, diccionarios para agrupar las propiedades de cada transacción, un entero acumulador para la suma y una lista secundaria para guardar los nombres filtrados.

# %%
## Autoevaluación rápida

## 1. ¿Puedo elegir entre lista, tupla y diccionario según el problema?
## Respuesta: Sí, uso listas si necesito datos modificables, tuplas si son valores fijos y diccionarios cuando requiero la relación clave-valor.

## 2. ¿Puedo recorrer una colección y acumular un resultado?
## Respuesta: Sí, iterando con un ciclo for sobre los elementos e incrementando una variable acumuladora o agregando datos a una lista nueva.

## 3. ¿Puedo filtrar registros dentro de una lista de diccionarios?
## Respuesta: Sí, recorriendo la lista con un ciclo for y evaluando con un if los campos requeridos en cada diccionario.

## 4. ¿Puedo explicar por qué una tupla no admite asignación por índice?
## Respuesta: Sí, porque las tuplas son inmutables por diseño para proteger la integridad de los datos en memoria.